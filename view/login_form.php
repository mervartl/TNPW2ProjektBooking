...
<div class="container mt-5">
    <div class="card mx-auto p-4 shadow" style="max-width: 400px;">
        ...
        <?php if (!empty($_SESSION['login_error'])): ?> <!-- Zobrazení chybové hlášky při neúspěšném přihlášení -->
            <div class="alert alert-danger"><?= htmlspecialchars($_SESSION['login_error']) ?></div>
            <?php unset($_SESSION['login_error']); ?>
        <?php endif; ?>

        <form action="../controller/login.php" method="POST"> <!-- Formulář pro odeslání přihlašovacích údajů -->
            <div class="mb-3">
